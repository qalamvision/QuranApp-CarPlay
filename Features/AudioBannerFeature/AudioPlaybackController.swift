...
final class AudioPlaybackController {
    ...
    typealias Observer = @MainActor (Snapshot) -> Void
    ...
    func getReciters() async -> [Reciter] {
        if reciters.isEmpty {
    ...
    nonisolated static func surahTitle(for surahNumber: Int, withNumber: Bool = false) -> String {
