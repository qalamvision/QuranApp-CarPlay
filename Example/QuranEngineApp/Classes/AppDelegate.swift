...
//    private func setupCarPlaySupport() {
//        let mediaManager = MediaPlayerManager.shared
//        mediaManager.setupRemoteTransportControls()
//    }
    ...
    func application(
        ...
        case .carTemplateApplication:
            print("[CarPlay] Creating CarPlay scene config")
            return UISceneConfiguration(
                name: "CarPlay Configuration",
                sessionRole: connectingSceneSession.role
            )
        default:
            print("[App] Creating default scene config")
            return UISceneConfiguration(
